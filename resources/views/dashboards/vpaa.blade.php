<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1">
            ...
            <p class="text-sm text-gray-500">Endorse and forward reclassification submissions.</p>
        </div>
    </x-slot>

    <div class="py-12 bg-bu-muted min-h-screen">
        <div id="vpaa-dashboard-live"
             data-auto-refresh
             data-ux-panel
                ...
                <div class="ux-skeleton-card space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div class="ux-skeleton h-8 w-36"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="ux-skeleton-card space-y-3">
                            <div class="ux-skeleton h-5 w-28"></div>
                            <div class="ux-skeleton h-3 w-full"></div>
                            <div class="ux-skeleton h-11 w-full"></div>
                            <div class="ux-skeleton h-11 w-full"></div>
                        </div>
                        <div class="ux-skeleton-card space-y-3">
                            <div class="ux-skeleton h-5 w-36"></div>
                            <div class="ux-skeleton h-3 w-full"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                    <div class="text-xs text-gray-500">Pending VPAA</div>
